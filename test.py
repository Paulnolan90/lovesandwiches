...
class RockPaperScissors:
    def __init__(self):
        ...
        self.random_number = random.randint(0, 2) # randomly generates a number to be used as the computers guess.
        self.options = ["rock", "paper", "scissors"] # creates a variable and numbers 0,1,2 rock,paper,scissors for use in the random generator.
